...
import { History, Folder, Plus, Trash2, ChevronRight, Play, Share2 } from 'lucide-react';
                        ...
                        {collections.map(col => (
                            <div key={col.id} className="group flex items-center justify-between px-2 py-1.5 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-md cursor-pointer text-sm">
                                ...
                                <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                                    <button onClick={(e) => { e.stopPropagation(); onShareCollection(col); }} className="text-slate-400 hover:text-blue-500" title="Share Collection">
                                        <Share2 size={12} />
                                    </button>
                                    <button onClick={(e) => { e.stopPropagation(); onDeleteCollection(col.id); }} className="text-slate-400 hover:text-red-500" title="Delete Collection">
                                        <Trash2 size={12} />
                                    </button>
                                </div>
                            </div>
